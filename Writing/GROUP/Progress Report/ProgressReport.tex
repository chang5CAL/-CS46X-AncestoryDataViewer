...
No problems this week.
\subsubsection{Progress}
We met with each other, and discuss our schedules. We set up communication and emailed our client to plan a meeting. Our TA contacted us and we selected a time for meeting with him. We set up GitHub repository and group OneNotes for version control and project management.
...
\subsubsection{Progress}
We met with our client, Ashley, and talk about some requirements that she has for the project. We wrote a rough draft, and we met with our client over Google Hangouts.
...
\subsubsection{Progress}
We had our first official meeting with our TA. We touched base and explained our project to him. The rough draft was revised and submitted. We also added more content to reach the word requirement. We spent a few hours trying to configure our makefile but it didn't work.
