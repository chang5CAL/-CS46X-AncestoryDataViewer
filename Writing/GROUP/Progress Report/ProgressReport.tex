...
\hline
Established Technologies: There are existing tools and information that we can use for our project. Therefore, the main problem to be solved is the display algorithm.
&Workflow is slow: We are doing badly on time management and meeting all the criteria for the assignments.
&Establish a tighter schedule and work on time management. Start early on assignments and get it finish asap. Do more revising and check if all criteria of the assignments are met.
